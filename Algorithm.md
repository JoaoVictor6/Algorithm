...
1. [**Round Robin**](obsidian://open?vault=Algorithm&file=Round%20Robin) - Algoritmo de escalonamento em sistemas operacionais, onde cada processo recebe uma quantidade de tempo igual para execução em uma ordem circular.
